...
if tempo > 15:
  ...
  if forma_pagamento == "dinheiro" or forma_pagamento == "Dinheiro":
    ...
    elif cartao != "crédito" and cartao != "Crédito" and cartao != "credito" and cartao != "Credito" and cartao != "débito" and cartao != "Débito" and cartao != "debito" and cartao != "Debito":
  ...
  elif forma_pagamento != "dinheiro" and forma_pagamento != "Dinheiro" and forma_pagamento != "cartão" and forma_pagamento != "Cartão" and forma_pagamento != "cartao" and forma_pagamento != "Cartao":
